...
| `docs/openapi-ccn.json` | Stage 3: the fork's 29 operations (OpenAPI 3.1, upstream's style, `x-ccn-extends` on `PUT /templates/{id}`); generated by a one-off script, hand-editable |
